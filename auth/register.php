                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if (empty($errors)) {
                        ...
                        if ($stmt->execute()) {
                            ...
                            header("Location: ../misc/welcome.html");
                            exit();
                        } else {
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="3" onkeyup="this.value = this.value.toUpperCase();" required
                        name="retailer_code" class="form-control p_input">
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
              ...
              <form class="hide-on-sm" method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label>Retailer Code</label>
                      <input type="text" required name="retailer_code" onkeyup="this.value = this.value.toUpperCase();"
                        maxlength="3" class="form-control p_input">
                    </div>
                  </div>
                </div>
                <div class="row">
            ...
            <div class="bottom-ever">
              <footer class="footer bg-transparent">
                <div class="w-100 grid-center">
                  <span class="d-block text-center"><b>&copy; BRND SCENTS 2023. Built by <u><a
                          href="https://github.com/coresystechng" target="_blank">CORE-TECH</a></u></b>.</span>
                </div>
              </footer>
            </div>
          </div>
